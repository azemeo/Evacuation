...
namespace UnityEngine.UI.Extensions
{
    ...
    public class ReorderableListElement : MonoBehaviour, IDragHandler, IBeginDragHandler, IEndDragHandler
    {
        ...
        public void OnDrag(PointerEventData eventData)
        {
            ...
            RectTransformUtility.ScreenPointToLocalPointInRectangle(_reorderableList.DraggableArea, eventData.position, eventData.enterEventCamera, out lPos);
            _draggingObject.localPosition = lPos;
            Vector3 wPos = _draggingObject.position;
